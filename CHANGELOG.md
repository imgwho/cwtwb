...
- **Release refresh for a republish**: bumped the package version so the project can be published again after the previous `0.18.8` artifacts already existed on PyPI.
