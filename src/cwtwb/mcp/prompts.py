    ...
    return [
        {
            ...
            "content": (
                ...
                "5. Call dashboard_brief_to_contract to think about the draft shape, then call draft_authoring_contract.\n"
                "6. Call review_authoring_contract_for_run.\n"
                "7. If intent is still missing, call light_elicitation and ask only those questions.\n"
                "8. Call finalize_authoring_contract.\n"
                "9. Stop and ask the human to confirm the finalized contract.\n"
                "10. After approval, call confirm_authoring_stage with stage='contract'. If the human rejects it, stay in the contract phase.\n"
                "11. Call authoring_execution_plan to reason about the build, then call build_execution_plan.\n"
                "12. Stop and ask the human to confirm the execution plan.\n"
                "13. After approval, call confirm_authoring_stage with stage='execution_plan'.\n"
                "14. Only after confirmation, call generate_workbook_from_run.\n"
                "15. Finish by summarizing the run id, key artifacts, final workbook path, validation, and analysis.\n\n"
                f"Human brief:\n{brief}\n\n"
