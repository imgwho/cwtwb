    ...
    return [
        {
            ...
            "content": (
                ...
                "4. After approval, call confirm_authoring_stage with stage='schema'. If the human rejects it, do not draft the contract yet.\n"
                "5. Call build_analysis_brief and summarize the candidate dashboard directions using the generated Markdown review file.\n"
                "6. Call finalize_analysis_brief, even if the human keeps the default direction, and then stop for human analysis confirmation.\n"
                "7. After approval, call confirm_authoring_stage with stage='analysis'. If the human rejects it, stay in the analysis phase.\n"
                ...
                "12. Stop and ask the human to confirm the finalized contract.\n"
                "13. After approval, call confirm_authoring_stage with stage='contract'. If the human rejects it, stay in the contract phase.\n"
                "14. Call build_wireframe and summarize the ASCII wireframe and support/workaround notes from the Markdown review file.\n"
                "15. Call finalize_wireframe, even if the human keeps the default layout, and then stop for human wireframe confirmation.\n"
                "16. After approval, call confirm_authoring_stage with stage='wireframe'. If the human rejects it, stay in the wireframe phase.\n"
                "17. Call authoring_execution_plan to reason about the build, then call build_execution_plan.\n"
                "18. Stop and ask the human to confirm the execution plan. Treat execution_plan.md as read-only.\n"
                "19. After approval, call confirm_authoring_stage with stage='execution_plan'.\n"
