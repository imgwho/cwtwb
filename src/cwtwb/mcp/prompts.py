    ...
    return [
        {
            ...
            "content": (
                ...
                "5. Call build_analysis_brief to create the analysis review scaffold. In agent_first mode, you must author 2-4 explicit dashboard directions yourself based on the schema and the human conversation.\n"
                "6. Call finalize_analysis_brief with explicit directions plus selected_direction_id, and then prefer interactive_stage_confirmation with stage='analysis'.\n"
                ...
                "11. Call finalize_authoring_contract only after you have written an explicit executable contract spec: worksheet names, mark types, fields, filters, actions, and encodings.\n"
